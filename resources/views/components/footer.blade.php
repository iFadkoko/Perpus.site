<footer class="bg-gray-100">
    <div class="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
      <div class="absolute end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
        <a
          class="inline-block rounded-full bg-indigo-800 p-2 text-white shadow transition hover:bg-indigo-300 sm:p-3 lg:p-4"
          href="#MainContent"
        >
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
            <div class="shrink-0 flex items-center ">
                <img class="size-12 ml-2" src="img/logo.png" alt="Your Company"> <h2 class="ml-10 text-indigo-900 font-bold">Perpustakaan Politeknik Pajajaran</h2>
            </div>
