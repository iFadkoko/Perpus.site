...
<!-- Navigation Links -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ebooks')" :active="request()->routeIs('ebooks')">
                {{ __('e-Books') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('daftarbuku')" :active="request()->routeIs('daftarbuku')">
                {{ __('Daftar Buku') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('peminjaman')" :active="request()->routeIs('peminjaman')">
                {{ __('Peminjaman') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-amber-300">{{ Auth::user()->name }}</div>
