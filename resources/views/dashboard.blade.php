    ...
    <section class="bg-gray-50 py-12 sm:py-16 lg:py-20 xl:py-24">
        ...
        class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <p class="text-sm font-bold uppercase tracking-widest text-gray-700">Step By Step</p>
                <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Berikut Panduan Meminjam Buku 
                </h2>
                <p class="mx-auto mt-4 max-w-2xl text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
                    IKUTI DAN PAHAMI DARI SETIAP LANGKAH, BERIKUT 4 LANGKAH YANG WAJIB KAMU LAKUKAN !!
                </p>
            </div>
