...
<x-app-layout>
    ...
    <div class="flex w-4/4">
        <div class="container ">
            ...
            <a class="px-3 py-1 text-sm text-white bg-blue-500 rounded hover:bg-blue-600 mr-3 m-3 " href="{{ Route('daftarbuku') }}"   
                >Kembali</a>
            <div class="card bg-white shadow-xl p-10 m-3 rounded-lg w-80">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div class="bg-white h-auto drop-shadow-2xl p-2 rounded-lg mt-2">
